...
${n.items[a].notifyUploader?'<span class="notification-bubble notification-bubble__item-notification">!</span>':""}
 ...
 <div class="margin-bottom--extra-small"><span class="text--black">Last updated: </span> <span class="faded">${n.items[a].lastUpdatedDate.split("T")[0]}</span></div>
          ...
          </a>`}}else i='<div class="no-items"><p>No items to display<p></div>';$("#item-list").html(i);let t="",e=0,a=0;if(a=n.numOfTotalResults<=numOfItemsPerPage?e=0:(e=Math.ceil(n.numOfTotalResults/numOfItemsPerPage),e-2),!(e<2)){if(pageNum=s+1,2<=pageNum?t+=`<li class="pagination__item">
