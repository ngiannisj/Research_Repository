function showItemDeleteModal(e){$("#deleteItemModal").show();e=e.value;$("#delete-item-modal-button").val(e),event.preventDefault()}function filterTags(e){e=[parseInt(e.find(":selected").attr("value"))];$.ajax({type:"GET",url:"/Item/GetThemeTags",data:{ids:e},dataType:"json",cache:!1,traditional:!0,success:function(e){if(e){$("#checkboxes label").hide();for(var t=0;t<e.length;t++)$("#tag-input-id-"+e[t]).parent().show()}},error:function(){console.log(error)}})}function filterProjects(e){e=[parseInt(e.find(":selected").attr("value"))];$.ajax({type:"GET",url:"/Item/GetTeamProjects",data:{ids:e},dataType:"json",cache:!1,traditional:!0,success:function(e){if(e){$("#project-selector option:not(:first)").hide();for(var t=0;t<e.length;t++)$("#project-selector option[value="+e[t]+"]").show()}},error:function(e){console.log(e)}})}$(document).ready(function(){$(".open-delete-team-modal-btn").click(function(){$("#deleteTeamModal").show();var e=$(this).val();$("#delete-team-confirm-btn").val(e),event.preventDefault()}),$("#close-delete-team-modal-button, .teamModalClose").click(function(){$("#deleteTeamModal").hide(),event.preventDefault()}),$(document).mouseup(function(e){const t=$("#deleteTeamModal");t.is(":visible")&&t.is(e.target)&&0===t.has(e.target).length&&t.hide()}),$("#open-project-delete-modal-btn").click(function(){$("#myProjectModal").hide(),$("#deleteProjectModal").show(),event.preventDefault()}),$("#close-delete-project-modal-button, .projectModalClose").click(function(){$("#deleteProjectModal").hide(),$("#myProjectModal").show(),event.preventDefault()}),$(document).mouseup(function(e){const t=$("#deleteProjectModal");t.is(":visible")&&t.is(e.target)&&0===t.has(e.target).length&&t.hide()}),$(".open-delete-theme-modal-btn").click(function(){$("#deleteThemeModal").show();var e=$(this).val();$("#delete-theme-confirm-btn").val(e),event.preventDefault()}),$("#close-delete-theme-modal-button, .themeModalClose").click(function(){$("#deleteThemeModal").hide(),event.preventDefault()}),$(document).mouseup(function(e){const t=$("#deleteThemeModal");t.is(":visible")&&t.is(e.target)&&0===t.has(e.target).length&&t.hide()}),$("#open-delete-tag-modal-btn").click(function(){$("#myTagModal").hide(),$("#deleteTagModal").show(),event.preventDefault()}),$("#close-delete-tag-modal-button, .tagModalClose, #tag-delete-button").click(function(){$("#deleteTagModal").hide(),$("#myTagModal").show(),event.preventDefault()}),$(document).mouseup(function(e){const t=$("#deleteTagModal");t.is(":visible")&&t.is(e.target)&&0===t.has(e.target).length&&t.hide()}),$("#open-delete-item-modal-btn").click(function(){showItemDeleteModal(this)}),$("#close-delete-item-modal-button, .itemModalClose").click(function(){$("#deleteTagModal").hide(),event.preventDefault()}),$("#delete-item-modal-button").click(function(){var e=$(this).val();$.ajax({type:"GET",url:"/Item/Delete",data:{id:e},contentType:"application/json; charset=utf-8",success:function(){window.location.href="../profile"}})}),$(document).mouseup(function(e){const t=$("#deleteItemModal");t.is(":visible")&&t.is(e.target)&&0===t.has(e.target).length&&t.hide()})}),$(document).ready(function(){$(":checkbox").change(function(){$(this).is(":checked")?($(this).attr("checked",!0),$(this).parent().addClass("field__label--checkbox-checked")):($(this).attr("checked",!1),$(this).parent().removeClass("field__label--checkbox-checked"))}),$("#filters").length&&filterTags($("#theme-selector")),$("#filters").length&&filterProjects($("#team-selector")),$("#theme-selector").change(function(){filterTags($(this))}),$("#team-selector").change(function(){filterProjects($(this))})});var expanded=!1;function showCheckboxes(){var e;0==$("#tag-selector select").prop("disabled")&&(e=document.getElementById("checkboxes"),expanded=expanded?!(e.style.display="none"):(e.style.display="block",!0))}function selectListOptionClick(e){$(e).closest(".accordion__container--select-list").find(".accordion__button--select-list").first().attr("data-selected",$(e).data("value")),$(e).closest(".accordion__container--select-list").find(".accordion__button--select-list").first().html($(e).text())}function highlightSelectedNavLink(){window.location.href.toLowerCase().includes("item/upsert")?$("#contribute-nav-link").addClass("header__nav-link--active"):window.location.href.toLowerCase().includes("item")&&!window.location.href.toLowerCase().includes("itemrequest")&&!window.location.href.toLowerCase().includes("account")||window.location.href.toLowerCase().includes("item?filterType")?$("#library-nav-link").addClass("header__nav-link--active"):window.location.href.toLowerCase().includes("itemrequest")||window.location.href.toLowerCase().includes("theme")||window.location.href.toLowerCase().includes("team")||window.location.href.toLowerCase().includes("account")?($("#librarian-nav-link").addClass("header__nav-link--active"),$("#login-nav-link").addClass("header__nav-link--active")):(window.location.href.toLowerCase().includes("profile")?$("#profile-nav-link"):$("#home-nav-link")).addClass("header__nav-link--active")}function addKeyInsightField(e){var t=$(e).parent().find(".key-insight-field").length;const a=$(e).parent();a.append(`<div class="key-insight-field row">
                ...
                </tr>`),$("#filters.published-filters").length){let t="";if(i.items[a].tags)for(let e=0;e<i.items[a].tags.length;e++)t+=`
                <div class="pill">
                  <img
                    class="pill__image"
                    ...
                    alt="tag_image"
                  />${i.items[a].tags[e]}
                </div>`;e+=`<a href="/Item/View/${i.items[a].id}" class="card card--pathway">
            <div class="card__content">
              <div class="card__heading-container">
                <h4 class="card__heading">${i.items[a].title}</h4>
              ...
              <div class="card__description-container">
          ...
          </a>`}$("#item-list").html(e);let t="",a=0,n=0;if(n=i.numOfTotalResults<=numOfItemsPerPage?a=0:(a=Math.ceil(i.numOfTotalResults/numOfItemsPerPage),a-2),pageNum=s+1,2<=pageNum?t+=`<li class="pagination__item">
                ...
                <button class="pagination__button ${1==pageNum?"pagination__button--active":""}" onclick="updateFilterParameters(0, '${o}')">1</button>
                </li>`,4<=pageNum&&(t+='<li class="pagination__item">...</li>'),1<=n)if(pageNum<=2)for(let e=s;e<=3;e++)0<e&&(t+=`<li class="pagination__item">
                            <button class="pagination__button ${pageNum==e+1?"pagination__button--active":""}"  onclick="updateFilterParameters(${e}, '${o}')">
                            ${e+1}
                            </button>
                            </li>`);else if(pageNum>=a-1)for(let e=n-2;e<=n;e++)t+=`<li class="pagination__item">
                            <button class="pagination__button ${pageNum==e+1?"pagination__button--active":""}" onclick="updateFilterParameters(${e}, '${o}')">
                            ${e+1}
                            </button>
                            ...
                            </li>`;pageNum<=a-3&&(t+='<li class="pagination__item">...</li>'),1<=a&&(t+=`<li class="pagination__item">
                    <button class="pagination__button ${pageNum==a?"pagination__button--active":""}" onclick="updateFilterParameters(${a-1}, '${o}')">
                    ${a}
                    </button>
                    </li >`),pageNum<a?t+=`<li class="pagination__item">
